...
<title>To-Do List dengan Modal Edit & Tambah</title>
<style>
    body {
        background: #f1f5f9;
    ...
    /* Tabel lebih rapi */
    /* Update tabel dengan border dan font yang lebih bagus */
table {
    width: 100%;
    border-collapse: collapse;
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    font-size: 15px;
    color: #374151; /* abu gelap kalem */
}
...
tbody tr {
    border-bottom: 1px solid #e5e7eb; /* garis tipis antar baris */
    transition: background-color 0.3s ease;
}

tbody tr:hover {
    background-color: #e0e7ff; /* shading biru lembut */
    cursor: pointer;
}
...
<script>
    ...
    // Isi modal edit dengan data dari tombol edit yang diklik
